 ...
 shl cx,0xA ; Shift the value of CX 10 bits to the left
 ...
 jl .read_sector_loop ; If not then loo again
jmp .finish ; If we are here, then nothing wrong happened and we should skip printing an error
.read_disk_error:
mov si,disk_error_msg ; If we are here then something wrong happened and we need to print an error message
 call bios_print
 jmp hang
.finish:
